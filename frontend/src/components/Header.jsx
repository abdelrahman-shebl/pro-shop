          ...
          <nav className='hidden lg:flex items-center gap-6'>
            ...
            {userInfo && userInfo.isAdmin && (
              <div className='relative' ref={adminDropdownRef}>
                ...
                {adminDropdownOpen && (
                  <div className='absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 overflow-hidden'>
                    <Link
